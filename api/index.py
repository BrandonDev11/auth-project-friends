...
class GameInfo:
    def __init__(self):
        self.TitleId: str = "18BAE0"  # Playfab Title Id
        self.SecretKey: str = "BQSTZTZPCFEKWCAU6QK5HMK45E139ZIDWU4NT6X4K4IPDD6BPT"  # Playfab Secret Key
        self.ApiKey: str = "OC|1109525968920826|969410d0dd537cff7e0c0302ff00239f"  # App Api Key (Oculus/Graph API)
